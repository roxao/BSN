...
<html>
<head>
    <title>bukti user transfer dari user
    </title>
</head>
<body>
<form action="<?php echo base_url('admin_verifikasi_controller/VERIF_PAY_REQ_SUCCEST') ?>" method="post">
    <?php
    ...
    <input type="submit" name="setujui bukti transfer" value="setujui" class="btn btn-success"/>
