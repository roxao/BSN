...
<p><h1>CEK BUKTI REVISI TRANSFER</h1></p>
<form action="<?php echo base_url('admin_verifikasi_controller/VERIF_REV_PAY_REQ_SUCCEST') ?>" method="post">
<!-- <form action="<?php echo base_url('admin_verifikasi_controller/VERIF_REV_PAY_REQ_REVISI') ?>" method="post"> -->
