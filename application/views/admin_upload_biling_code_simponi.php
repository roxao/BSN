...
<html>
<head>
    <title>form admin_upload_biling_code_simponi
    </title>
</head>
<body>
<form action="<?php echo base_url('inbox_setujui_proses_upload_billing') ?>" method="post">
    <?php
    ...
    <button><a href="<?php echo base_url('inbox_setujui_proses_dokumen') ?>" method="post">setuju</a></button>
    <input type="submit" name="setujui" value="setujui" class="btn btn-success"/>
    <input type="submit" name="tolak" value="tolak" class="btn btn-success"/>
    <?php
        } 
    ?>  
