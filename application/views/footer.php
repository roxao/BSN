		...
		<div class="footer_container clearfix">
			...
			<div class="float_right footer_content_right">
				...
				<div class="footer_contact_list">
					<div><svg class="sprite_icon float_left" fill="#555"><use xlink:href="<?=base_url()?>assets/ic_socmed.svg#ic_address"/></svg>
					...
					<div><svg class="sprite_icon float_left" fill="#555"><use xlink:href="<?=base_url()?>assets/ic_socmed.svg#ic_phone"/></svg>
						<div>021 1234 1234 - 021 1234 1234</div>
					</div>
					<div><svg class="sprite_icon float_left" fill="#555"><use xlink:href="<?=base_url()?>assets/ic_socmed.svg#ic_mail"/></svg>
