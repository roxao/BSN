<section class="dashboard_content sheets_paper">
  <section class="main_dashboard_slidetab">
    <h2 class="title_content">PENGATURAN ADMIN</h2>
    <div id="tableInbox" style=" margin: 0 -20px 0 -20px">
      <?php
        $s_name = [
          ...
          ['username', 'Username'],  
          ['email', 'Alamat Email'],
          ['admin_role', 'Jabatan Admin'],
          ['admin_status', 'Status Admin']
        ];
      ?>
      <div class="clearfix"  style="margin: 0 15px">
        <div class="float_left">
          <button id="create-btn" class="btn-flat">SAMPLE BUTTON</button>
...
<div class="z-modal-frame" style="display: none;">
  <div id="z-modal-edit" style="display: none;">
    <div class="z-modal-header">
      <div class="z-modal-title">Ubah Data Admin</div>
      <div class="z-modal-close"></div>
    </div>
    <div class="z-modal-content">
      <form class="modal-form" action="" method="post">
        <div class="z-modal-form">
            <input name="id_admin" type="hidden" id="id_admin"/>
            <label>Username
            ...
            <br/>
            <center><button type="insert" name="insert" value="insert" class="btn-flat">Ubah Data User</button></center>
          </div>
      </form>
    </div>
  </div>
