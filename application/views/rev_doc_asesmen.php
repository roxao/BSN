...
<html>
<head>
    <title>Upload documen hasil asesment
    </title>
</head>
<body>

<p><h1>UPLOAD REVISI DOKUMEN DARI TIM ASESMEN</h1></q>
<form action="<?php echo base_url('admin_verifikasi_controller/VERIF_REV_ASSESS_RES_REQ_PROSES') ?>" method="post">
<!-- <form action="<?php echo base_url('admin_verifikasi_controller/VERIF_REV_ASSESS_RES_REQ_REVISI') ?>" method="post"> -->
    ...
    <input type="submit" name="revisi" value="revisi" class="btn btn-success"/>
    <?php
        } 
    ?>  
