...
<html>
<head>
    <title>HASIL ASESMENT LAPANGAN
    </title>
</head>
<body>

<p><h1>HASIL ASSESMENT LAPANGAN</h1></q>
<!-- <form action="<?php echo base_url('admin_verifikasi_controller/UPL_RES_ASSESS_REQ_SUCCESS') ?>" method="post"> -->
<form action="<?php echo base_url('admin_verifikasi_controller/UPL_RES_ASSESS_REQ_REVISI') ?>" method="post">
    <?php
